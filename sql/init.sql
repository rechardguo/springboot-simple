...
CREATE TABLE `user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `tel` bigint(20) NOT NULL COMMENT '用户ID，手机号码',
...
INSERT INTO `user` VALUES (1,13000000000,'user0','b7797cce01b4b131b433b6acf4add449','1a2b3c',NULL,'2017-11-30 09:01:59',NULL,1);
UNLOCK TABLES;